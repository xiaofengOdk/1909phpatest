                  ...
                  @foreach($navgoods as $k=>$v)
                    <li class="yui3-u-1-4">
                        ...
                        <div class="list-wrap">               
                            ...
                            <div class="p-img"><a style="text-decoration: none; color:black;" href="{{url('/index/goods_desc/'.$v->goods_id)}}"><img src="{{env('UPLOADS_URL')}}{{$v->goods_img}}" style="width: 300;height: 200;"></a></div>
